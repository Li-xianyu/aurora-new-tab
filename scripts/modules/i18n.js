...
const dictionaries = {
  "zh-CN": {
    ...
    bookmarkDelete: "删除",
    contextMenuRefresh: "刷新本页",
    contextMenuCut: "剪切",
    contextMenuCopy: "复制",
    contextMenuPaste: "粘贴",
    contextMenuSelectAll: "全选",
    contextMenuOpenNewTab: "新标签打开",
    contextMenuOpenNewWindow: "新窗口打开",
    contextMenuOpenIncognito: "隐私打开",
    contextMenuCopyLink: "复制链接",
    contextMenuSaveLinkAs: "链接另存为",
    contextMenuOpenSettings: "进入设置",
  ...
  en: {
    ...
    settingsScreenLoopLabel: "Loop screens",
    settingsScreenLoopAria: "Loop screens",
    ...
    contextMenuRefresh: "Refresh Page",
    contextMenuCut: "Cut",
    contextMenuCopy: "Copy",
    contextMenuPaste: "Paste",
    contextMenuSelectAll: "Select All",
    contextMenuOpenNewTab: "Open in New Tab",
    contextMenuOpenNewWindow: "Open in New Window",
    contextMenuOpenIncognito: "Open Incognito",
    contextMenuCopyLink: "Copy Link",
    contextMenuSaveLinkAs: "Save Link As",
